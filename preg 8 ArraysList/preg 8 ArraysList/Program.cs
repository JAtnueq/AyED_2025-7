...
namespace preg_4_ArrayList
{
    class Program
    {
        ...
        {
            /*Escribe un programa en Csharp para ordenar una lista de arrays.*/
            ...
            Console.WriteLine("El Array esta desordenado, presiona Enter para ordenarlo");
            Console.ReadLine();
            miLista.Sort();
            //---------------------------------------
            ...
            Console.WriteLine("--------------------------------------");
            Console.WriteLine("\n(La lista se ordeno por orden alfabetico. Ejemplo: a, b, c, etc.)");
            Console.ReadKey();
